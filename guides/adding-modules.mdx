...
Browse the [Module catalog](/modules/overview) here, search [npm](https://www.npmjs.com/search?q=%4086d-store), or ask the CLI:
...
<Steps>
  <Step title="Add it">
    ...
    It takes a short name (`reviews`), a scoped name (`@86d-store/reviews`), a GitHub specifier (`github:owner/repo/modules/loyalty`), or an npm specifier (`npm:@acme/commerce-module`). The full grammar is at [`86d module add`](/cli/commands#86d-module-add-specifier).
  </Step>
