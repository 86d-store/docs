...
Every [Feature](/resources/glossary#feature) in 86d is a [Module](/concepts/modules), including every first-party entry in the generated registry. There is no privileged internal API: what you write gets the same treatment as `@86d-store/products`. Your Module can add [Storefront](/concepts/storefront) components, [Store Admin](/concepts/admin) pages, and API endpoints.
...
<Steps>
  ...
  <Step title="Enable it">
    ...
    This adds `@86d-store/my-feature` to your active [Template](/concepts/templates)'s `config.json`.
  </Step>
