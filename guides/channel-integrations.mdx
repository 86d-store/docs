...
Confirm the [Module](/concepts/modules) exists in the [first-party registry](https://github.com/86d-store/86d/blob/main/apps/registry/registry.json), then check:
