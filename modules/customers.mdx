...
The Customers [Module](/concepts/modules) manages the [Customer](/resources/glossary#customer) record that backs every authenticated [Shopper](/resources/glossary#shopper). Customers can read and update their profile, change their email, and change their password. You can search, filter, and edit Customer records through the admin endpoints. `@86d-store/loyalty`, `@86d-store/saved-addresses`, `@86d-store/customer-groups`, and most engagement Modules depend on it.

**Source:** [`modules/customers`](https://github.com/86d-store/86d/tree/main/modules/customers) · **npm:** [`@86d-store/customers`](https://www.npmjs.com/package/@86d-store/customers)
