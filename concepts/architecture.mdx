...
Managed capabilities appear as **86d Cloud**, **86d Payments**, managed hosting, managed email, and managed AI. Upstream suppliers behind those services do not appear in 86d Console, Store Admin, emails, pricing, support, or errors. When you bring your own [Connection](/concepts/connections) or [host the Store Runtime yourself](/deployment), the provider you chose may appear because that relationship is yours.
